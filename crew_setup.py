...
def build_crew() -> Crew:
    ...
    compare_task = Task(
        description=(
            ...
            "- Flipkart now searches Flipkart Minutes (hyperlocal quick-commerce, "
            "not the general catalog). Its results should be relevant groceries "
            "from recognised brands. If anything is wildly off-topic, skip it.\n"
